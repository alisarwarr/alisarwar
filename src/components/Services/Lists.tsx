                    ...
                    <ListItemAvatar>
                       <div
                            style={{
                                ...
                                marginTop: (name==="HTML"||name==="CSS")?3:((name==="SASS")?6:(name==="JAVASCRIPT"||name==="TYPESCRIPT"||name==="ECMASCRIPT")?3:(name==="SOLIDITY"?-12:((name==="REACT JS"||name==="REACT NATIVE"||name==="CONTEXT")?-12:(name==="NEXT JS"?3:(name==="PWA"?-3:(name==="GRAPHQL"?-3:(name==="JAM STACK"?9:name==="MERN STACK"?-1:(name==="AWS"?17:(name==="CONTENTFUL"?1:(name==="TAILWIND"?4:((name==="MATERIAL UI"?2:(name==="STYLED COMPONENT"?5:(name==="SQL"?-4:(name==="MYSQL"?6:(name==="MSSQL"?2:(name==="POSTGRESQL"?5:(name==="MONGODB"?-2:(name==="FAUNADB"?5:(name==="VERCEL"?4:(name==="NETLIFY"?3:(name==="NETLIFY"?9:((name==="FIREBASE"||"FIRESTORE")?3:((name==="S3 ( AWS )"||name==="LAMBDA ( AWS )"||name==="DYNAMODB ( AWS )"||name==="COGNITO ( AWS )"||name==="APIGATEWAY ( AWS )")?-3:(name==="APPSYNC ( AWS )"?5:(name==="AMPLIFY ( AWS )"?3:(name==="FIGMA"?1:0))))))))))))))))))))))))))),
